...
class ExternalDataTypeUpdatingDataSourceIntoDocumentEventArgs(RevitAPIPreDocEventArgs):
    @property
    def TypeId(self) -> ElementId: ...


class ExternalDataTypeUpdatedDataSourceIntoDocumentEventArgs(RevitAPIPostDocEventArgs):
    @property
    def TypeId(self) -> ElementId: ...
    @property
    def ProjectId(self) -> str: ...
